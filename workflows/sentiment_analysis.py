...
class SentimentAnalysisSystem(Workflow):
    web_analyzer: Agent = Agent(
        ...
        instructions=[
            ...
            "1. Cari 10-15 sumber terpercaya terkait topik",
            "2. Prioritaskan konten dengan engagement tinggi",
            "3. Cari sosial media dan forum dengan diskusi aktif",
            "4. Identifikasi sumber dari berbagai platform",
            "5. Evaluasi kredibilitas dan relevansi sumber",
            "6. Ekstrak data engagement dan metrics",
        ],
